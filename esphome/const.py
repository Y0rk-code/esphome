...
CONF_BROKER = 'broker'
CONF_BRUSH_TIME_SECONDS = 'brush_time_seconds'
CONF_BSSID = 'bssid'
...
CONF_IS_HIGH_PRESSURE = 'is_high_pressure'
CONF_IS_PROFESSIONAL_TIMER = 'is_professional_timer'
CONF_IS_REDUCED_MOTOR = 'is_reduced_motor'
